...
def configure_tempest() {
    ...
    sh '''
    cd $HOME/tempest/etc/
    sudo wget https://raw.githubusercontent.com/CasJ/openstack_one_node_ci/master/tempest.conf
    '''
...
def parse_benchmarks(results_file = 'results') {
	...
	sh """
           cat \$HOME/output/${results_file}.json | elastic-benchmark -e osa-${results_file}
        """
}
